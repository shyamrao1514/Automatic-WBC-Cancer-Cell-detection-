...
def blood_cell_count(file_name):
    ...
    for prediction in output:
        ...
        if(label=='WBC' and radius > 100):
            label="wbc cancer detected "
            wbc_cancer+=1
            wbc-=1
    ...
    cv2.imshow('Total RBC: ' + str(rbc) + ', WBC ' + str(wbc) + ', Platelets: ' + str(platelets)+' ,wbc cancer cells: '+ str(wbc_cancer), image)
